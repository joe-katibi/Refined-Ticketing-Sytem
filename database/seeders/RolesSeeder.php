...
class RolesSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = ['view-dashboard-escalation', 'view-escalation-menu', 'view-create-escalation', 'view-edit-escalation', 'view-view-escalation', 'view-history-escalation', 'view-escalation-notification-mark-read',
            ...
            'view-appointment-infrastructure-history-view', 'view-appointment-noc-history-view', 'view-appointment-notification-menu', 'view-notifications-appointment', 'view-dashboard-outage', 'view-outage-menu'];
        ...
        $permissions = ['view-dashboard-escalation', 'view-escalation-menu', 'view-escalations-menu', 'view-create-escalation', 'view-edit-escalation', 'view-view-escalation', 'view-history-escalation', 'view-escalation-notification-mark-read',
            ...
            'view-appointment-noc-menu', 'view-appointment-noc-history-menu', 'view-appointment-infrastructure-history-view', 'view-appointment-noc-history-view', 'view-appointment-notification-menu', 'view-notifications-appointment', 'view-dashboard-outage', 'view-outage-menu', 'view-outage-notification-menu', 'view-outage-notification-mark-read'];
        foreach ($permissions as $permissionName) {
            $permission = Permission::where('name', $permissionName)->first();
        ...
        $permissions = ['view-escalation-menu', 'view-dashboard-escalation', 'view-escalate-menu', 'view-escalations-menu', 'view-escalation-categories-menu', 'view-escalation-notification-menu', 'view-escalation-report-menu', 'view-create-escalation',
            ...
            'view-notifications-appointment', 'view-reports-appointment', 'view-types-appointment', 'view-final-reasons-appointment', 'view-statuses-appointment', 'create-statuses-appointment', 'edit-statuses-appointment', 'delete-statuses-appointment',
            'view-appointment-regions-menu', 'view-appointment-regions-create', 'view-appointment-regions-edit'];
        foreach ($permissions as $permissionName) {
            $permission = Permission::where('name', $permissionName)->first();
            // Assign the permission to the role
        ...
        $permissions = ['view-dashboard-escalation', 'view-escalation-menu', 'view-create-escalation', 'view-edit-escalation', 'view-view-escalation', 'view-history-escalation', 'view-escalation-notification-mark-read',
            'view-dashboard-appointment', 'view-appointments-menu', 'view-appointment-infrastructure-menu', 'view-appointment-infrastructure-history-menu', 'view-appointment-noc-menu', 'view-appointment-noc-history-menu',
            'view-appointment-infrastructure-history-view', 'view-appointment-noc-history-view', 'view-appointment-notification-menu', 'view-notifications-appointment', 'view-dashboard-outage', 'view-outage-menu', 'view-outage-notification-menu', 'view-outage-notification-mark-read'];
        foreach ($permissions as $permissionName) {
            $permission = Permission::where('name', $permissionName)->first();
        ...
        $permissions = ['view-escalation-menu', 'view-dashboard-escalation', 'view-escalate-menu', 'view-escalations-menu', 'view-escalation-notification-menu', 'view-create-escalation', 'view-edit-escalation', 'view-view-escalation',
            ...
            'view-appointment-infrastructure-history-menu', 'view-appointment-infrastructure-history-view', 'view-appointment-noc-menu', 'view-appointment-noc-history-menu', 'view-appointment-noc-history-view', 'view-appointment-notification-menu', 'view-notifications-appointment',
        ...
        $permissions = ['view-escalation-menu', 'view-dashboard-escalation', 'view-escalate-menu', 'view-escalations-menu', 'view-escalation-categories-menu', 'view-escalation-create-categories', 'view-escalation-notification-menu', 'view-create-escalation',
            ...
            'view-appointment-infrastructure-history-view', 'view-appointment-noc-menu', 'view-appointment-noc-history-menu', 'view-appointment-noc-history-view', 'view-appointment-notification-menu', 'view-notifications-appointment', 'view-appointment-create', 'view-appointment-view',
        ...
        $permissions = ['view-escalation-menu', 'view-dashboard-escalation', 'view-escalate-menu', 'view-escalations-menu', 'view-escalation-notification-menu', 'view-create-escalation', 'view-edit-escalation', 'view-view-escalation',
            ...
            'view-reports-appointment', 'view-types-appointment', 'view-final-reasons-appointment', 'view-statuses-appointment', 'create-statuses-appointment', 'edit-statuses-appointment', 'delete-statuses-appointment'];
        foreach ($permissions as $permissionName) {
            $permission = Permission::where('name', $permissionName)->first();
        ...
        $permissions = ['view-appointment-menu', 'view-dashboard-appointment', 'view-my-appointments-menu', 'view-appointment-infrastructure-menu', 'view-appointment-infrastructure-history-menu', 'view-appointment-infrastructure-history-view',
            'view-appointment-noc-menu', 'view-appointment-noc-history-menu', 'view-appointment-noc-history-view', 'view-appointment-notification-menu', 'view-notifications-appointment', 'view-my-appointment-edit', 'view-dashboard-outage', 'view-outage-menu', 'view-my-outage-menu',
