...
@section('title', 'Create Affected Area')
        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                    ...
                    <p class="text-muted mb-0">Add a new area that can be affected during outages</p>
                </div>
                <div class="card-body">
                    @if ($errors->any())
                    ...
                    <form action="{{ route('outages.affected-areas.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12 mb-3">
                                ...
                                <textarea class="form-control @error('area_description') is-invalid @enderror" 
                                          ...
                                          rows="4" 
                                          placeholder="Enter a detailed description of this affected area">{{ old('area_description') }}</textarea>
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                ...
                                <select class="form-select @error('area_status') is-invalid @enderror" 
                                    ...
                                    <option value="Active" {{ old('area_status') == 'Active' ? 'selected' : '' }}>
                                        Active
                                    </option>
                                    <option value="Inactive" {{ old('area_status') == 'Inactive' ? 'selected' : '' }}>
                                        Inactive
                                    </option>
                                </select>
                                @error('area_status')
