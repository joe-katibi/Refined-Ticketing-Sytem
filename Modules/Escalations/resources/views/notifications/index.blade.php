                                ...
                                <tr class="{{ $notification->read ? '' : 'table-info' }}">
                                    ...
                                    <td>
                                        @switch($notification->type)
                                            @case('create')
                                                <span class="badge badge-success text-white" style="font-size: 13px; padding: 8px 12px;">Created</span>
                                                @break
                                            @case('update')
                                                <span class="badge badge-info text-white" style="font-size: 13px; padding: 8px 12px;">Updated</span>
                                                @break
                                            @case('assign')
                                                <span class="badge badge-primary text-white" style="font-size: 13px; padding: 8px 12px;">Assigned</span>
                                                @break
                                            @case('close')
                                                <span class="badge badge-secondary text-white" style="font-size: 13px; padding: 8px 12px;">Closed</span>
                                                @break
                                            @case('sla_breach')
                                                <span class="badge badge-danger text-white" style="font-size: 13px; padding: 8px 12px;">SLA Breach</span>
                                                @break
                                            @case('sla_warning')
                                    ...
                                    <td>
                                        @if($notification->escalation)
                                            <a href="{{ route('escalations.show', $notification->escalation->id) }}">
                                                {{ $notification->escalation->ticket_id }}
                                            </a>
                                        @else
                                            N/A
                                        @endif
                                    ...
                                    <td>
                                        <div class="btn-group">
                                            ...
                                            @endif
                                            @if($notification->escalation)
                                                <a href="{{ route('escalations.show', $notification->escalation->id) }}" class="btn btn-info ml-1">
