...
@section('title', 'Productivity Report - Escalations')
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">Individual performance metrics and SLA compliance by team member</p>
                    </div>
                    <div>
                        ...
                        <a href="{{ route('escalations.reports.export-excel', ['report_type' => 'productivity', 'date_from' => $dateFrom, 'date_to' => $dateTo]) }}" class="btn btn-success btn-xs">
                ...
                <div class="card-body">
                    <!-- Date Filter Form -->
                    <form method="GET" action="{{ route('escalations.reports.productivity') }}" class="mb-4">
                        <div class="row">
                            <div class="col-md-4">
                                    ...
                                    <div class="row text-center">
                                        ...
                                        <div class="col-md-3">
                                            <div class="small-box bg-warning text-dark p-3 rounded">
                                                @php
                                                    $totalClosed = $userMetrics->sum('total_closed');
                                                    $totalWithinSla = $userMetrics->sum('closed_within_sla');
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Individual User Performance</h5>
                                </div>
                                <div class="card-body">
