...
@section('title', 'Sub Team Productivity Report - Appointments')
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        <h4 class="card-title mb-0">
                            ...
                            Sub Team Productivity Report
                        </h4>
                        <p class="text-muted mb-0">Sub team performance metrics and SLA compliance by sub team types</p>
                    </div>
                    <div>
                        ...
                        <a href="{{ route('appointment.reports.export-excel', ['report_type' => 'sub_team_productivity', 'startDate' => $startDate, 'endDate' => $endDate]) }}" class="btn btn-success btn-xs">
                ...
                <div class="card-body">
                    <!-- Date Filter Form -->
                    <form method="GET" action="{{ route('appointment.reports.sub-team-productivity') }}" class="mb-4">
                        <div class="row">
                            <div class="col-md-4">
                        ...
                        <div class="col-12">
                            <div class="card bg-light">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Sub Team Summary Statistics</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row text-center">
                                        <div class="col-md-3">
                                            <div class="small-box bg-info text-white p-3 rounded">
                                                <h3>{{ $subTeamMetrics->count() }}</h3>
                                                <p class="mb-0">Active Sub Teams</p>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="small-box bg-success text-white p-3 rounded">
                                                <h3>{{ $subTeamMetrics->sum('total_closed') }}</h3>
                                                <p class="mb-0">Total Closed</p>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="small-box bg-primary text-white p-3 rounded">
                                                <h3>{{ $subTeamMetrics->sum('closed_within_sla') }}</h3>
                                        ...
                                        <div class="col-md-3">
                                            <div class="small-box bg-warning text-dark p-3 rounded">
                                                @php
                                                    $totalClosed = $subTeamMetrics->sum('total_closed');
                                                    $totalWithinSla = $subTeamMetrics->sum('closed_within_sla');
                    ...
                    <!-- Sub Team Productivity Table -->
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Sub Team Performance Details</h5>
                                </div>
                                <div class="card-body">
                                    <div class="table-responsive">
                                        <table class="table table-striped table-hover">
                                            ...
                                            <tbody>
                                                @forelse($subTeamMetrics as $metric)
                                                @php
                                                    $performanceClass = $metric->sla_compliance_percentage >= 80 ? 'success' : ($metric->sla_compliance_percentage >= 60 ? 'warning' : 'danger');
                                                    $closureRate = $metric->total_assigned > 0 ? round(($metric->total_closed / $metric->total_assigned) * 100, 1) : 0;
                                                @endphp
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <strong>{{ $metric->sub_type_name }}</strong>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <span class="badge badge-xs bg-info">{{ $metric->total_assigned }}</span>
                                                    </td>
                                                    <td class="text-center">
                                                    ...
                                                    <td class="text-center">
                                                        <span class="badge badge-xs bg-{{ $performanceClass }}">{{ $metric->sla_compliance_percentage }}%</span>
                                                    </td>
                                                    <td class="text-center">
                                                ...
                                                <tr>
                                                    <td colspan="8" class="text-center text-muted">
                                                        ...
                                                        No sub team productivity data available for the selected date range
                                                    </td>
                                                </tr>
                                                @endforelse
                                            </tbody>
