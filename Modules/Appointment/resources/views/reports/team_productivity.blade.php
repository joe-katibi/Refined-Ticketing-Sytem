...
@section('title', 'Team Productivity Report - Appointments')
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <div>
                        ...
                        <p class="text-muted mb-0">Team performance metrics and SLA compliance by assigned teams</p>
                    </div>
                    <div>
                        ...
                        <a href="{{ route('appointment.reports.export-excel', ['report_type' => 'team_productivity', 'startDate' => $startDate, 'endDate' => $endDate]) }}" class="btn btn-success btn-xs">
                ...
                <div class="card-body">
                    <!-- Date Filter Form -->
                    <form method="GET" action="{{ route('appointment.reports.team-productivity') }}" class="mb-4">
                        <div class="row">
                            <div class="col-md-4">
                                    ...
                                    <div class="row text-center">
                                        ...
                                        <div class="col-md-3">
                                            <div class="small-box bg-warning text-dark p-3 rounded">
                                                @php
                                                    $totalClosed = $teamMetrics->sum('total_closed');
                                                    $totalWithinSla = $teamMetrics->sum('closed_within_sla');
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="d-flex align-items-center">
                                                            ...
                                                            <strong>{{ $metric->type_name }}</strong>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td colspan="8" class="text-center text-muted">
                                                        ...
                                                        No team productivity data available for the selected date range
                                                    </td>
                                                </tr>
                                                @endforelse
                                            </tbody>
