...
@section('title', 'Create Final Reason')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">Create Final Reason</h3>
                </div>
                <div class="card-body">
                    <form action="{{ route('appointment.final-reasons.store') }}" method="POST">
                        @csrf
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="final_reason_name" id="final_reason_name"
                                   ...
                                   value="{{ old('final_reason_name') }}" required>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="final_reason_description" id="final_reason_description"
                                     ...
                                     rows="3">{{ old('final_reason_description') }}</textarea>
                        ...
                        <div class="form-group">
                            ...
                            <select name="final_reason_status" id="final_reason_status"
                                ...
                                <option value="Active" {{ old('final_reason_status') == 'Active' ? 'selected' : '' }}>Active</option>
                                <option value="Inactive" {{ old('final_reason_status') == 'Inactive' ? 'selected' : '' }}>Inactive</option>
                            </select>
