...
@section('title', 'Design New Appointments')
...
<div class="container-xxxl flex-grow-1 container-p-y">
    ...
    <div class="card">
        <div class="card-header d-flex justify-content-between align-items-center">
            <h5 class="mb-0">Design New Appointments</h5>
            <small class="text-muted">All assigned appointments with status 'Escalated-Design'</small>
        </div>
        <div class="card-body">
            @if(session('success'))
            ...
            <div class="table-responsive">
                <table id="design-new-table" class="table table-bordered">
                    <thead>
                        <tr>
                            <th>#</th>
                            <th>Ticket ID</th>
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="11" class="text-center">No Design appointments found.</td>
                            </tr>
                        @endforelse
                    </tbody>
                </table>
