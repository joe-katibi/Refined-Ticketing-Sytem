        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('appointment.statuses.update', $status) }}" method="POST">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" 
                                value="{{ old('name', $status->name) }}" required {{ $status->is_system ? 'readonly' : '' }}>
                            <small class="form-text text-muted">
                                This is the internal name used in the system.
                                @if($status->is_system)
                                    <span class="text-danger">System status names cannot be changed.</span>
                                @endif
                            </small>
                            @error('name')
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('display_name') is-invalid @enderror" id="display_name" 
                                name="display_name" value="{{ old('display_name', $status->display_name) }}" required>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('description') is-invalid @enderror" id="description" 
                                name="description" rows="3">{{ old('description', $status->description) }}</textarea>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control @error('badge_class') is-invalid @enderror" id="badge_class" 
                                name="badge_class" value="{{ old('badge_class', $status->badge_class) }}">
                        ...
                        <div class="mb-3">
                            ...
                            <select class="form-select @error('status') is-invalid @enderror" id="status" name="status" required>
                                ...
                                <option value="Inactive" {{ old('status', $status->status) == 'Inactive' ? 'selected' : '' }}>Inactive</option>
                            </select>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" class="form-control @error('sort_order') is-invalid @enderror" id="sort_order" 
                                name="sort_order" value="{{ old('sort_order', $status->sort_order) }}">
