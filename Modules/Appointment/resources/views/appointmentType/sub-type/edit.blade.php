...
@section('title', 'Edit Sub-Appointment Type')
        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h3 class="card-title">
                        Edit Sub-Appointment Type: {{ $subType->sub_type_name }}
                    </h3>
                ...
                <div class="card-body">
                    <form action="{{ route('appointment.types.sub-types.update', [$appointmentType->id, $subType->id]) }}" method="POST">
                        @csrf
                        @method('PUT')
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select name="sub_type_status" id="sub_type_status"
                                            ...
                                            required>
                                        <option value="Active" {{ old('sub_type_status', $subType->sub_type_status) == 'Active' ? 'selected' : '' }}>Active</option>
                                        <option value="Inactive" {{ old('sub_type_status', $subType->sub_type_status) == 'Inactive' ? 'selected' : '' }}>Inactive</option>
                                    </select>
                        ...
                        <div class="form-group">
                            ...
                            <textarea name="sub_type_description" id="sub_type_description"
                                     ...
                                     rows="3">{{ old('sub_type_description', $subType->sub_type_description) }}</textarea>
