...
class UserController extends Controller
{
    ...
    {
        // Log the incoming request data for debugging (password excluded — this
        // form carries a plaintext password, and logging it would put it in
        // storage/logs/laravel.log indefinitely).
        \Log::info('User Creation Request Data:', $request->except(['password', 'password_confirmation']));
